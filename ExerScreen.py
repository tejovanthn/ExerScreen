...
page = bsoup( urllib.urlopen( "http://runkeeper.com/user/" + str(user_id) ), "lxml" )
...
#When inactive (user is at the system), it updates the score if it comes out of active state
